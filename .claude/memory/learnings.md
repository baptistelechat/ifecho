...
| [LRN-040](learnings/LRN-040.md) | 2026-06-22 | `text-ember` 3.42:1 ❌ → `text-heat-700` 5.17:1 ✅ ; muted-fg → stone-600  | #tailwind #wcag #accessibility #contrast #color #ember #heat-700 #stone-600                       |
| [LRN-041](learnings/LRN-041.md) | 2026-06-22 | WCAG 2.5.3 : `aria-label` doit contenir le texte visible                   | #wcag #accessibility #aria-label #a11y #label-content-name-mismatch #lighthouse                   |
| [LRN-042](learnings/LRN-042.md) | 2026-06-22 | Lighthouse CLI EPERM Windows → Node API (`chrome-launcher`)                | #lighthouse #windows #eperm #node-api #chrome-launcher #audit #pwa                                |
| [LRN-043](learnings/LRN-043.md) | 2026-06-22 | `preconnect` sans `crossorigin` = inefficace pour ressources CORS          | #html #preconnect #crossorigin #cors #fetch #performance #lighthouse                              |
| [LRN-044](learnings/LRN-044.md) | 2026-06-22 | `llms.txt` format llmstxt.org requis par Lighthouse agentic-browsing       | #lighthouse #llms-txt #seo #agentic-browsing #pwa #format                                         |
| [LRN-045](learnings/LRN-045.md) | 2026-06-22 | Event analytics composé → consumer multi-hooks, pas hook fetch             | #analytics #react #hooks #posthog #useEffect #composition #event-placement #multi-hooks           |
