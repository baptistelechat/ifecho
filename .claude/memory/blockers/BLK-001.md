...
# BLK-001 — Deadline 36h — livraison avant lundi 22 juin

| Friction                            | Cause réelle                                         | Solution                                                 | Statut |
| ----------------------------------- | ---------------------------------------------------- | -------------------------------------------------------- | ------ |
| Trop de features, trop peu de temps | Canicule historique ~27 juin 2026 → intérêt éphémère | Scope V0 radical : ventilation + vitrage conseils + .ics | ouvert |
